...
public class CreateCities {
    ...
    private Map<Cities, Integer> createWays;
    ...
    public Map<Cities, Integer> getCreateWays() {
        return createWays;
    }
    ...
    public void setCreateWays(Map<Cities, Integer> createWays) {
    ...
    public CreateCities(String createTitle, Map<Cities, Integer> createWays){
        Validator.validateTitle(createTitle);
        this.createTitle = createTitle;
    ...
    //Добавление пути
    public void addCreateWay(Cities city, int cost){
    ...
    public String toString(){
        ...
        for (Map.Entry<Cities, Integer> entry : createWays.entrySet()){
